...
public class PassengerAutoCommand extends SequentialCommandGroup {
    public PassengerAutoCommand(Drivetrain drive){
        ...
        addCommands(
            ...
            new WaitCommand(0.12),//Wait until it's facing 2nd location
            new InstantCommand(()->drive.tankDrive(1, 1)),//Go straight to go to 2nd location
            new WaitCommand(0.5),//Wait until it's near/at 2nd location
            ...
            new InstantCommand(()->drive.tankDrive(-1, -0.5)),
            new WaitCommand(1.6),
            new InstantCommand(()->drive.tankDrive(-1, -0.25)),
            new WaitCommand(0.5),
